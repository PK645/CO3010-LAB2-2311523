...
#define DURATION_3 10
#define DURATION_4 10
  ...
  while (1)
    {
  	  ...
  	  if (timer4_flag == 1) {
  	      ...
  	      matrix_index++;
  	      if (matrix_index >= 8) matrix_index = 0;
  	    }
      /* USER CODE END WHILE */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SEG0_Pin|SEG1_Pin|SEG2_Pin|ROW_2_Pin
                          |ROW_3_Pin|ROW_4_Pin|ROW_5_Pin|ROW_6_Pin
                          |ROW_7_Pin|SEG3_Pin|SEG4_Pin|SEG5_Pin
                          |SEG6_Pin|ROW_0_Pin|ROW_1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SEG0_Pin SEG1_Pin SEG2_Pin ROW_2_Pin
                           ROW_3_Pin ROW_4_Pin ROW_5_Pin ROW_6_Pin
                           ROW_7_Pin SEG3_Pin SEG4_Pin SEG5_Pin
                           SEG6_Pin ROW_0_Pin ROW_1_Pin */
  GPIO_InitStruct.Pin = SEG0_Pin|SEG1_Pin|SEG2_Pin|ROW_2_Pin
                          |ROW_3_Pin|ROW_4_Pin|ROW_5_Pin|ROW_6_Pin
                          |ROW_7_Pin|SEG3_Pin|SEG4_Pin|SEG5_Pin
                          |SEG6_Pin|ROW_0_Pin|ROW_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
